...
3. h2 в карточках переименовал на h3 (h2- название "Лоты"), при этом h4 сделал p как описание содержимого карточки.  В секции теперь только один h2, три h3  и три p.
